...
const AlertDialogFooter = (
  { className, ...props }: React.HTMLAttributes<HTMLDivElement> & { className?: string } // Added className validation
) => (
  <div
...
const AlertDialogCancel = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof AlertDialogPrimitive.Cancel> & { className?: string } // Added className validation
>(({ className, ...props }, ref) => (
